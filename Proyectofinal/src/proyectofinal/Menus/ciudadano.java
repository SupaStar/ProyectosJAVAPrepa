...
public class ciudadano extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String curp,nombre,ap1,ap2,rfc,fecha_nac;
        curp=jTextField1.getText();
        nombre=jTextField2.getText();
        ap1=jTextField3.getText();
        ap2=jTextField4.getText();
            ...
            String contraseña = "obednoe1";
             ...
             if ( con != null ) 
                ...
                stmt = con.createStatement();
                  stmt.executeUpdate("INSERT INTO ciudadano VALUES('"+curp+"','"+nombre+"','"+ap1+"','"+ap2+"','"+fecha_nac+"')");
