 ...
 * @author Robert
 */
public class choque extends javax.swing.JFrame {
    Calendar cal=Calendar.getInstance();
  String fecha=cal.get(cal.DATE)+"/"+cal.get(cal.MONTH)+"/"+cal.get(cal.YEAR);
  String hora=cal.get (cal.HOUR_OF_DAY)+":"+cal.get(cal.MINUTE)+":"+cal.get(cal.SECOND);

    /**
     * Creates new form choque
     */
    public choque() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Nombre del afectado");
        ...
        jLabel1.setText("CHOQUE DE AUTOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(choque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
