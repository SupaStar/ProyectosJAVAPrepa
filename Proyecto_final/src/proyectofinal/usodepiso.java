 ...
 * @author Robert
 */
public class usodepiso extends javax.swing.JFrame {
    Calendar cal=Calendar.getInstance();
  String fecha=cal.get(cal.DATE)+"/"+cal.get(cal.MONTH)+"/"+cal.get(cal.YEAR);
  String hora=cal.get (cal.HOUR_OF_DAY)+":"+cal.get(cal.MINUTE)+":"+cal.get(cal.SECOND);

    /**
     * Creates new form usodepiso
     */
    public usodepiso() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Plazo de tiempo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usodepiso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
