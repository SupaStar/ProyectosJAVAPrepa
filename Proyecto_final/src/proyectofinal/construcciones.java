...
public class construcciones extends javax.swing.JFrame {
  ...
  String hora=cal.get (cal.HOUR_OF_DAY)+":"+cal.get(cal.MINUTE)+":"+cal.get(cal.SECOND);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("METROS CUADRADOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(construcciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new construcciones().setVisible(true);
            }
        });
    }
